...
degree_unemployment_plot <- ggplot(degree_unemployment_table, aes(x=Year),colour=variable) + 
  ...
  labs(x ="Year", y = "Unemployment Rate (in %)", title = "Average Unemployment Rate by Degree Per Year")
...
gender_unemployment_plot <- ggplot(gender_unemployment_table) +
  geom_line(mapping = aes(x = Year, y = unemployment_rate, group = Gender, color = Gender)) +
  labs(x = "Year",
       y = "Unemployment Rate (in %)",
...
The purpose for including chart two was to visually depict the relations between degree and unemployment rate. The insight gained from this was that certain degrees had lower rates of unemployment than other degrees (Notably, as education levels rose, unemployment rates dropped).

The purpose for including chart three was to visually depict the relations between gender and unemployment rate. The insight gained from this was that certain genders had lower rates of unemployment then other genders (Notably, Men had a higher unemployment rate than women).
